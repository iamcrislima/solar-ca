...
export const MOCK_SERVICOS_AV: Servico[] = [
  ...
  { servico: 'Renovação de alvará',                    categoria: 'Alvarás, autorizações e licenças',    setor: 'SMPHDU/SDU/DLAE/Gerência de Alvarás',              destino: ['Empresa'],
    detalhe: {
      ...
      documentacaoFluxo: '<p>O fluxo de renovação passa por <strong>conferência cadastral</strong>, <strong>análise da Gerência de Alvarás</strong> e <strong>emissão do novo alvará</strong>. Havendo débitos ou pendências, o processo retorna ao solicitante para regularização antes da emissão.</p>',
    } },
