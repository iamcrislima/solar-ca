...
export default function ServicoForm({ service }: { service: Servico }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: '24px 24px 48px 24px' }}>
      ...
      {/* Card do formulário — formulário dinâmico direto, sem etapas (opção Solar BPM) */}
      <div style={{ background: 'white', border: '1px solid var(--card-border)', borderRadius: 10, padding: 28, boxShadow: '0px 4px 12px rgba(24,39,75,0.10)', display: 'flex', flexDirection: 'column', gap: 28 }}>

        {/*  Dados do solicitante  */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <h2 style={{ fontWeight: 700, fontSize: 16, color: 'var(--neutral-ink-strong)', margin: 0, paddingBottom: 12, borderBottom: '1px solid var(--neutral-light-medium)', display: 'flex', alignItems: 'center', gap: 8 }}>
            <FAIcon icon="fa-regular fa-user" style={{ fontSize: 15, color: 'var(--primary-pure)' }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <h2 style={{ fontWeight: 700, fontSize: 16, color: 'var(--neutral-ink-strong)', margin: 0, paddingBottom: 12, borderBottom: '1px solid var(--neutral-light-medium)', display: 'flex', alignItems: 'center', gap: 8 }}>
            <FAIcon icon="fa-regular fa-clipboard-list" style={{ fontSize: 15, color: 'var(--primary-pure)' }} />
            {t('sfDetalhesTitle')}
          </h2>
          <div style={{ display: 'flex', gap: 16 }}>
            <div style={{ flex: 2 }}>
        ...
        {/* Botão de envio — sem navegação por etapas */}
        <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', paddingTop: 18, borderTop: '1px solid var(--neutral-light-medium)' }}>
